...
ActiveRecord::Schema.define(version: 20170312225626) do
  ...
  add_index "customers", ["birth_year", "family_name_kana", "given_name_kana"], name: "index_customers,on_birth_year_and_furigana", using: :btree
